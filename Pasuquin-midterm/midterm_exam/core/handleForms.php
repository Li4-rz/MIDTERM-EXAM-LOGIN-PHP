<?php
    ...
    if (isset($_POST['insertNewProjectBtn'])) {
        ...
        if (isset($_SESSION['username'])){
            ...
            $query = insertProject($pdo, $_POST['projectName'], $_POST['technologiesUsed'], $_GET['web_dev_id'], $username);
    ...
    if (isset($_POST['editProjectBtn'])) {
        ...
        if (isset($_SESSION['username'])){
            ...
            $query = updateProject($pdo, $_POST['projectName'], $_POST['technologiesUsed'], $_GET['project_id'], $username);
    ...
    if (isset($_POST['registerUserBtn'])) {
        ...
        if (!empty($username) && !empty($password)) {
            ...
            $_SESSION['message'] = "Please make sure thet the input fields are not empty for registration!";
